    ...
    private fun queryStandardTrashedFiles(): List<Map<String, Any>> {
        ...
        try {
            val projection = arrayOf(
                ...
                "date_trashed",  // ⚡ 添加真实删除时间 (Android 11+)
            ...
            cursor?.use {
                ...
                val trashedColumn = it.getColumnIndexOrThrow("date_trashed")
                LogHelper.d(TAG, "trashedColumn: $trashedColumn")
                ...
                while (it.moveToNext()) {
                    ...
                    val trashed = it.getLong(trashedColumn) * 1000 // 转换为毫秒 (真实删除时间)
                    ...
                    val fileInfo = mapOf(
                        ...
                        "trashedTime" to trashed,  // ⚡ 添加真实删除时间
        ...
        try {
            ...
            cursor?.use {
                ...
                while (it.moveToNext()) {
                    ...
                    val trashed = it.getLong(trashedColumn) * 1000  // ⚡ 真实删除时间
                    val mimeType = it.getString(mimeTypeColumn) ?: ""
