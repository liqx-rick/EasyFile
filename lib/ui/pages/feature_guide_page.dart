      ...
      body: ListView(
        ...
        children: [
          ...
          _buildFeatureCard(
            ...
            icon: Icons.tune,
            title: '功能配置',
            description: '在设置-功能设置中配置各项功能',
            details: [
              '• 新文件显示策略：配置保留天数（7天/15天/30天）和显示数量',
              '• 回收站功能：启用/禁用及保留天数设置（3/7/15/30天）',
              '• 智能推荐显示数量：控制首页智能推荐区的应用显示条件（3/5/10/50/100个文件）',
              '• 重置智能推荐：清除已选定的推荐应用，重新扫描和选择',
              '• 重复文件清理：设置最小文件阈值（10KB-10MB）',
            ],
          ),
